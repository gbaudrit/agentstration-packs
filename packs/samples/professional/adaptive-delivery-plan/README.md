...
Adaptively coordinate specialists to build a delivery plan for a complex initiative.
...
- Plan the migration of a legacy API.
- Prepare delivery phases for a local-first application.
